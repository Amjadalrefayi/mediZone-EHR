...
trait ApiResponse
{
    ...
    protected function showAllWithoutPagination($data, $url, $resource, $message = 'success', $code = 200): JsonResponse
    {
        $response = $resource::collection($data);

        return $this->responseReport($message, $url, $response, $code);
    }
